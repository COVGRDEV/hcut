...
function buscar() {
    ...
    if (profesional == '' && lugar == '' && estado == '' && fechaInicial == '' && fechaFinal == '' && cita == '' && tipoCita == '' && hora == '') {//Si todos los campos estan vacios
        ...
        var params = 'opcion=1&profesional=' + profesional + '&lugar=' + lugar + '&estado=' + estado + '&fechaInicial=' + fechaInicial_aux + '&fechaFinal=' + fechaFinal_aux + '&cita=' + cita + '&tipoCita=' + tipoCita + '&hora=' + hora;
...
function generarPDF() {
    ...
    if (profesional == '' && lugar == '' && estado == '' && fechaInicial == '' && fechaFinal == '' && cita == '' && tipoCita == '' && hora == '') {//Si todos los campos estan vacios
        ...
        var params = 'opcion=3&profesional=' + profesional + '&lugar=' + lugar + '&estado=' + estado + '&fechaInicial=' + fechaInicial_aux + '&fechaFinal=' + fechaFinal_aux + '&cita=' + cita + '&profesionalNombre=' + $('#cmb_profesional option:selected').text() + '&lugarNombre=' + $('#cmb_lugar option:selected').text() + '&estadoNombre=' + $('#cmb_estado_cita option:selected').text() + '&tipoCita=' + tipoCita + '&hora=' + hora;
