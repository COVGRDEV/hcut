...
var initCKEditorFormulas = (function(id_obj) {
...
//Funcion que busca las fórmular médicas
...
function guardarPlantilla(accion) {
    var result = 0;
	var text_formula = CKEDITOR.instances.text_formula.getData();
    var idCodigo = $('#hddidFormula').val();
	
    $("#cke_text_formula").removeClass("borde_error");
    if (text_formula == "") {
        $("#cke_text_formula").addClass("borde_error");
        result = 1;
    }
    ...
    if (result == 0) {//Guarda
        ...
        var text_formula2 = str_encode(CKEDITOR.instances.text_formula.getData());
