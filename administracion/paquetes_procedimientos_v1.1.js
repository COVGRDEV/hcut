...
function crear_paquete() {
    ...
    if (nom_paquete.length > 0 && cont_aux  > 0) {
        swal({//Alert de confirmación
            title: "¿Realmente desea crear el paquete?",
            type: "question",
            ...
            if (resultado.value) {//Evento aceptar
                swal({//Ventana temporal que muestra el progreso del ajax...
                    ...
                    onOpen: () => {
                        /*var checkValorUnico = $("#checkValorUnico").is(":checked") ? 1 : 0;
                        var checkAnestesia = $("#checkAnestesia").is(":checked") ? 1 : 0;
                        var checkAyudantia = $("#checkAyudantia").is(":checked") ? 1 : 0;
                        var checkDerechosSala = $("#checkDerechosSala").is(":checked") ? 1 : 0;
                        var checkInsumos = $("#checkInsumos").is(":checked") ? 1 : 0;
                        var txtValorUnico = $("#txtValorUnico").val();
                        var txtValorInsumosAdic = $("#txtValorInsumosAdic").val();*/
                        ...
                        params = "opcion=4&nom_paquete=" + nom_paquete +
	                             /*"&checkValorUnico=" + checkValorUnico +
								 "&checkAnestesia=" + checkAnestesia +
								 "&checkAyudantia=" + checkAyudantia +
								 "&checkDerechosSala=" + checkDerechosSala +
								 "&checkInsumos=" + checkInsumos +
								 "&txtValorUnico=" + txtValorUnico +
								 "&txtValorInsumosAdic=" + txtValorInsumosAdic +*/
