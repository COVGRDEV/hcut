...
function asigna_formato_textarea() {
   ...
   //$('#d_interno').addClass("div_interno_formulas");
...
function imprimir(){
	...
	if(tipo=='0'){$('#cmb_tipoImpresion').addClass("borde_error");result=1;}
...
function guardarPlantilla(accion) {
    ...
    if (result == 0) {//Guarda
        ...
        var params = 'opcion=4&indEstado=' + indEstadoAux + '&text_formula=' + text_formula2 + '&accion='+accion+'&idFormula=' + idCodigo;
