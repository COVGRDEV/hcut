	...
	$("#frm_nuevo_procedimiento").validate({
		...
		submitHandler: function () {
			var params = "opcion=3&tipo=1&cod_procedimiento=" + $("#txt_cod_procedimiento").val() +
						 ...
						 "&ind_lateralidad=" + ($("#chk_lateralidad").is(":checked") ? 1 : 0) +
						 "&cod_und_negocios=" + str_encode($("#cmb_cod_und_negocios").val()) +
						 "&cod_centro_costos=" + str_encode($("#cmb_cod_centro_costos").val()) +
