<?php session_start();
	/*
	 * Pagina para agregar documentos anexos a la historia clínica
	 * Autor: Feisar Moreno - 05/02/2015
	 */
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type='text/javascript' src='importar_anexos_v1.2.js'></script>
    </head>
    <body>
        <?php
        ...
        <div class="title-bar">
            <div class="wrapper">
                <div class="breadcrumb">
                    <ul>
                        <li class="breadcrumb_on">Importar documentos anexos</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="contenedor_principal">
            <div class="formulario" id="principal_historia_clinica" style="width: 100%; display: block; ">
                    ...
                    <table id="buscar" border="0" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="width: 40%;text-align: left;">
                                <input class="btnPrincipal peq" type="submit" value="Consultar" id="btn_consultar" name="btn_consultar" onclick="buscar_pacientes_hc();" />
                            </td>
                        </tr>
                        <tr>
                        	<td colspan="2">
                        		<div id="div_importar_historia_clinica" style="width: 100%; display: block;">
                ...
                <div id="d_paciente_hc" style="min-height: 30px;"></div>
            </div>
        </div>
