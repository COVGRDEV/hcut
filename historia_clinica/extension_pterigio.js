...
function obtener_parametros_consulta_pterigio() {
	...
	var params = "&pte_grado_od=" + $("#pte_grado_od").val() + 
				 ...
				 "&pte_foto_uploader_od=" + JSON.stringify(uploader_pte_foto_od.getUploads()) + 
				 "&pte_foto_tipo_arch_od=" + $("#pte_foto_tipo_arch_od").val() + 
				 "&pte_foto_id_lote_od=" + $("#pte_foto_id_lote_od").val() + 
				 //"&pte_obs_lote_od=" + "" //PENDIENTE 
				 "&pte_foto_uploader_oi=" + JSON.stringify(uploader_pte_foto_oi.getUploads()) + 
				 "&pte_foto_tipo_arch_oi=" + $("#pte_foto_tipo_arch_oi").val() + 
				 "&pte_foto_id_lote_oi=" + $("#pte_foto_id_lote_oi").val(); 
				 //"&pte_obs_lote_oi=" + "" //PENDIENTE 
	console.log(params);
