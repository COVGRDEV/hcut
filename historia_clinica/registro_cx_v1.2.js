...
function imprimir_hoja_stickers(id_admision, id_hc) {
	...
	llamarAjax("hoja_stickers_ajax.php", params, "d_impresion_stickers", "continuar_imprimir_hoja_stickers();");
}

function continuar_imprimir_hoja_stickers() {
	var ruta = $("#hdd_ruta_stickers_pdf").val();
	window.open("../funciones/abrir_pdf.php?ruta=" + ruta + "&nombre_arch=hoja_stickers.pdf", "_blank");
}
