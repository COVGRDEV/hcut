...
function imprimir_hc_resumen(id_paciente) {
    $("#d_btn_impr_completa_1").css("display", "none");
    $("#d_btn_impr_completa_2").css("display", "block");
    ...
    llamarAjax("impresion_historia_clinica_resumen.php", params, "d_impresion_hc", "continuar_imprimir_hc_resumen();");
}

function continuar_imprimir_hc_resumen() {
    var ruta = $("#hdd_ruta_arch_hc_pdf").val();
...
function obtener_parametros_filtros() {
    var params = "";
