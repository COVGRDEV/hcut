...
function validar_crear_hc() {
	...
	if($('#cmb_sexo').val()==''){ $("#cmb_sexo").addClass("borde_error"); result=1;}
...
function editar_crear_hc_fisica() {
	...
	var cmb_sexo = str_encode($('#cmb_sexo').val());
	...
	var params = 'opcion=3&id_paciente=' + hdd_id_paciente +
				 '&tipo_identificacion=' + cmb_tipo_id +
				 '&identificacion=' + txt_id +
				 '&sexo=' + cmb_sexo +
