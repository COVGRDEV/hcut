...
function editar_examen_optometria(tipo, ind_imprimir) {
	...
	var cadena_archivos = obtener_nombres_comp_archivos();
	
	llamarAjaxUploadFiles("registro_examen_op_ajax.php", params, "d_guardar_examen", "validar_exito(" + ind_imprimir + ");", "d_barra_progreso_ex", cadena_archivos);
}
...
function habilitar_botones_ex(ind_habilitar) {
	if (ind_habilitar) {
		$("#btn_imprimir").removeAttr("disabled");
