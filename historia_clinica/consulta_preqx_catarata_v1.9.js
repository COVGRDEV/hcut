...
function guardar_consulta(tipo, ind_imprimir) {
	switch (tipo) {
		...
		case 4: //Finalizar consulta desde traslado
			...
			var resultado = validar_consulta();
			if (resultado == 1) {
...
function validar_consulta() {
	...
	$("#cmb_locs3").removeClass("borde_error");
	$("#txt_val_locs3").removeClass("borde_error");
	$("#txt_val_rec_endotelial").removeClass("borde_error");
	$("#txt_val_paquimetria").removeClass("borde_error");
	$("#cmb_plegables").removeClass("borde_error");
	$("#cmb_rigido").removeClass("borde_error");
	$("#cmb_especiales").removeClass("borde_error");
	$("#cke_txt_evolucion").removeClass("borde_error");
	$("#cmb_anestesia").removeClass("borde_error");
	$("#txt_q_val_biometria_od").removeClass("borde_error");
	$("#txt_q_eje_biometria_od").removeClass("borde_error");
	$("#txt_q_val_iol_master_od").removeClass("borde_error");
	$("#txt_q_eje_iol_master_od").removeClass("borde_error");
	$("#txt_q_val_topografia_od").removeClass("borde_error");
	$("#txt_q_eje_topografia_od").removeClass("borde_error");
	$("#txt_q_val_definitiva_od").removeClass("borde_error");
	$("#txt_q_eje_definitiva_od").removeClass("borde_error");
	$("#txt_q_val_biometria_oi").removeClass("borde_error");
	$("#txt_q_eje_biometria_oi").removeClass("borde_error");
	$("#txt_q_val_iol_master_oi").removeClass("borde_error");
	$("#txt_q_eje_iol_master_oi").removeClass("borde_error");
	$("#txt_q_val_topografia_oi").removeClass("borde_error");
	$("#txt_q_eje_topografia_oi").removeClass("borde_error");
	$("#txt_q_val_definitiva_oi").removeClass("borde_error");
	$("#txt_q_eje_definitiva_oi").removeClass("borde_error");
	$("#hdd_img_queratometria_od").removeClass("borde_error");
	$("#hdd_img_queratometria_oi").removeClass("borde_error");
	$("#cmb_incision_arq").removeClass("borde_error");
	$("#txt_val_incision_arq").removeClass("borde_error");
	$("#cke_txt_observaciones_preqx").removeClass("borde_error");
    ...
    if ($("#cmb_anestesia").val() == ""){
		$("#cmb_anestesia").addClass("borde_error");
		resultado = -1;
		panel_2 = 1;
	}
	...
	if (bol_od) {
	    if ($("#txt_q_val_biometria_od").val() == ""){
			$("#txt_q_val_biometria_od").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	    if ($("#txt_q_eje_biometria_od").val() == ""){
			$("#txt_q_eje_biometria_od").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	    if ($("#txt_q_val_iol_master_od").val() == ""){
			$("#txt_q_val_iol_master_od").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	    if ($("#txt_q_eje_iol_master_od").val() == ""){
			$("#txt_q_eje_iol_master_od").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	    if ($("#txt_q_val_topografia_od").val() == ""){
			$("#txt_q_val_topografia_od").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	    if ($("#txt_q_eje_topografia_od").val() == ""){
			$("#txt_q_eje_topografia_od").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	    if ($("#txt_q_val_definitiva_od").val() == ""){
			$("#txt_q_val_definitiva_od").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	    if ($("#txt_q_eje_definitiva_od").val() == ""){
			$("#txt_q_eje_definitiva_od").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	}
	if (bol_oi) {
	    if ($("#txt_q_val_biometria_oi").val() == ""){
			$("#txt_q_val_biometria_oi").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	    if ($("#txt_q_eje_biometria_oi").val() == ""){
			$("#txt_q_eje_biometria_oi").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	    if ($("#txt_q_val_iol_master_oi").val() == ""){
			$("#txt_q_val_iol_master_oi").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	    if ($("#txt_q_eje_iol_master_oi").val() == ""){
			$("#txt_q_eje_iol_master_oi").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	    if ($("#txt_q_val_topografia_oi").val() == ""){
			$("#txt_q_val_topografia_oi").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	    if ($("#txt_q_eje_topografia_oi").val() == ""){
			$("#txt_q_eje_topografia_oi").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	    if ($("#txt_q_val_definitiva_oi").val() == ""){
			$("#txt_q_val_definitiva_oi").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	    if ($("#txt_q_eje_definitiva_oi").val() == ""){
			$("#txt_q_eje_definitiva_oi").addClass("borde_error");
			resultado = -1;
			panel_3 = 1;
		}
	}
    ...
    if ($("#cmb_incision_arq").val() == ""){
		$("#cmb_incision_arq").addClass("borde_error");
		resultado = -1;
		panel_3 = 1;
	}
    if ($("#cmb_incision_arq").val() == "1" && $("#txt_val_incision_arq").val() == ""){
		$("#txt_val_incision_arq").addClass("borde_error");
		resultado = -1;
		panel_3 = 1;
	}
