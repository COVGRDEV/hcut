...
function continuar_imprimir_cirugia() {
	...
	window.open("../funciones/abrir_pdf.php?ruta=" + ruta + "&nombre_arch=cirugia_laser.pdf", "_blank");
}
...
function limpiar_bordes() {
	...
	$("#proce_laser_4").removeClass("borde_error_panel");
	$("#proce_laser_4 a").css({"color": "#5B5B5B"});
...
function validar_cirugia() {
	...
	if (panel_4 == 1) {
	   $("#proce_laser_4").addClass("borde_error_panel");
	   $("#proce_laser_4 a").css({"color": "#FF002A"});
	}
...
function editar_cirugia(tipo, ind_imprimir){
	...
	llamarAjax("procedimiento_qx_laser_ajax.php", params, "d_guardar_cx", "validar_exito(" + tipo + ", " + ind_imprimir + ");");
}
