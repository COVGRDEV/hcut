...
require_once "../js/fine-uploader/Class_UploadHandler.php";
 ...
 */
    ...
    $result = $uploader->handleDelete($directorio);
    ...
    if (isset($_GET["done"])) {
        $result = $uploader->combineChunks($directorio);
    }
    // Handles upload requests
    else {
        // Call handleUpload() with the name of the folder, relative to PHP's getcwd()
        $result = $uploader->handleUpload($directorio);
