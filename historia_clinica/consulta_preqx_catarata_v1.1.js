...
imagen_queratometria_od.GuardandoPNGs = (function() {
	...
	return {
		...
		'sendToServerQueratometria_od': sendToServerQueratometria_od,
...
imagen_queratometria_oi.GuardandoPNGs = (function() {
	...
	return {
		...
		'sendToServerQueratometria_oi': sendToServerQueratometria_oi,
		'get_modificado': get_modificado
	};
});

var obj_imagen_queratometria_od;
var obj_imagen_queratometria_oi;
window.onload = function() {
	if (bol_od == true) {
		obj_imagen_queratometria_od = new imagen_queratometria_od.GuardandoPNGs();
		obj_imagen_queratometria_od.init_queratometria_od();
	}
	
	if (bol_oi == true) {
		obj_imagen_queratometria_oi = new imagen_queratometria_oi.GuardandoPNGs();
		obj_imagen_queratometria_oi.init_queratometria_oi();
	}
};
...
function editar_consulta(tipo) {
	...
	var params = "opcion=1&id_hc=" + $("#hdd_id_hc_consulta").val() +
				 ...
				 "&tipo_guardar=" + tipo;
	if (bol_od == true) {
		params += "&img_queratometria_od_modificado=" + obj_imagen_queratometria_od.get_modificado();
	} else {
		params += "&img_queratometria_od_modificado=0";
	}
	if (bol_oi == true) {
		params += "&img_queratometria_oi_modificado=" + obj_imagen_queratometria_oi.get_modificado();
	} else {
		params += "&img_queratometria_oi_modificado=0";
	}
...
function guardar_imagenes() {
	if (bol_od == true) {
		if (obj_imagen_queratometria_od.get_modificado() == 1) {
			obj_imagen_queratometria_od.sendToServerQueratometria_od();
		}
	}
	
	if (bol_oi == true) {
		if (obj_imagen_queratometria_oi.get_modificado() == 1) {
			obj_imagen_queratometria_oi.sendToServerQueratometria_oi();
		}
	}
}
