...
function validar_preqx_laser_of(){
	...
	//if($('#diagnostico_preqx_laser_of').val()==''){$('#diagnostico_preqx_laser_of').addClass("borde_error"); result=1; }
 ...
 */
function crear_preqx_laser_of(tipo) {
	...
	{ 
		case 1:
			$("#frm_consulta_preqx_laser_of").validate({
...
function editar_consulta_preqx_laser_of(tipo){
	...
	var preqx_laser_subjetivo = $('#preqx_laser_subjetivo').val();
	var preqx_laser_biomiocroscopia = $('#preqx_laser_biomiocroscopia').val();
	...
	var preqx_laser_plan = $('#preqx_laser_plan').val();
	...
	//llamarAjax("consulta_preqx_laser_of_ajax.php", params, "guardar_preqx_laser", "");				
}
