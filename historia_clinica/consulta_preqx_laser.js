...
function validar_preqx_laser(){
	...
	if (bol_od) {
		...
		if($('#refractivo_deseado_od').val()==''){ $("#refractivo_deseado_od").addClass("borde_error"); result=1; panel_1=1;}
		if($('#refractivo_esfera_od').val()==''){ $("#refractivo_esfera_od").addClass("borde_error"); result=1; panel_1=1;}
		if($('#refractivo_cilindro_od').val()==''){ $("#refractivo_cilindro_od").addClass("borde_error"); result=1; panel_1=1;}
		if($('#refractivo_eje_od').val()==''){ $("#refractivo_eje_od").addClass("borde_error"); result=1; panel_1=1;}
		...
		if($('#paquimetria_periferica_od').val()==''){ $("#paquimetria_central_od").addClass("borde_error"); result=1; panel_3=1;}
	}
	...
	if (bol_oi) {
		...
		if($('#refractivo_deseado_oi').val()==''){ $("#refractivo_deseado_oi").addClass("borde_error"); result=1; panel_1=1;}
		if($('#refractivo_esfera_oi').val()==''){ $("#refractivo_esfera_oi").addClass("borde_error"); result=1; panel_1=1;}
		if($('#refractivo_cilindro_oi').val()==''){ $("#refractivo_cilindro_oi").addClass("borde_error"); result=1; panel_1=1;}
		if($('#refractivo_eje_oi').val()==''){ $("#refractivo_eje_oi").addClass("borde_error"); result=1; panel_1=1;}
		...
		if($('#paquimetria_periferica_oi').val()==''){ $("#paquimetria_central_od").addClass("borde_error"); result=1; panel_3=1;}
	}	
 ...
 */
function crear_preqx_laser(tipo) {
...
function editar_consulta_preqx_laser(tipo){
	...
	//llamarAjax("consulta_preqx_laser_ajax.php", params, "guardar_preqx_laser", "");		
}
