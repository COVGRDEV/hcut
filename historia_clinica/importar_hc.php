<?php session_start();
	/*
	 * Pagina para Importar historias clinicas en pdf 
	 * Autor: Helio López - 26/09/2014
	 */
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="importar_hc_v1.3.js"></script>
    </head>
    <body>
        <?php
        ...
        <div class="title-bar">
            <div class="wrapper">
                <div class="breadcrumb">
                    <ul>
                        <li class="breadcrumb_on">Importar Historia Cl&iacute;nica</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="formulario" id="principal_historia_clinica" style="width: 100%; display: block; ">
                <form id="frm_historia_clinica" name="frm_historia_clinica" method="post">
                    <table id="buscar" border="0" style="width: 100%;">
                        ...
                        <tr>
                        	<td colspan="2"><h4>Buscar pacientes</h4></td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 40%;text-align: left;">
                                <input class="btnPrincipal peq" type="submit" value="Consultar" id="btn_consultar" name="btn_consultar" onclick="validar_buscar_personas_hc();" />
                            </td>
                        </tr>
                    </table>
                </form>
