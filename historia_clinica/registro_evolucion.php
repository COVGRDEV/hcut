...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type='text/javascript' src='registro_evolucion.js'></script>
    </head>
    <body>
        <?php
        ...
        <div class="title-bar">
            <div class="wrapper">
                <div class="breadcrumb">
                    <ul>
                        <li class="breadcrumb_on">Registro de Evoluciones</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <table id="buscar" border="0" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="width: 40%;text-align: left;">
                                <input class="btnPrincipal peq" type="submit" value="Consultar" id="btn_consultar" name="btn_consultar" onclick="buscar_pacientes();" />
                            </td>
                        </tr>
                    </table>
                </form>
