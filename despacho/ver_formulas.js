...
function validarBuscarPersonasHc() {
    ...
    $("#frm_formulas").validate({
        ...
        submitHandler: function() {
            ...
            llamarAjax("ver_formulas_ajax.php", params, "contenedor_paciente_hc", "");
...
function ver_registros_formulas(id_persona, nombre_persona, documento_persona, tipo_documento, telefonos, fecha_nacimiento, edad_paciente) {
