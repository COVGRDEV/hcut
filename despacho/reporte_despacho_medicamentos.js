...
function reporteGeneral() {
    ...
    if (fechaInicial == '' || fechaFinal == '') {
        ...
        llamarAjax("reporte_despacho_medicamentos_ajax.php", params, "reporte", "descargar_pdf();");
    }
}
...
function ventanaPacientes(tipo) {
    if (tipo == 1) {//mostrar
        ...
        llamarAjax("reporte_despacho_medicamentos_ajax.php", params, "d_interno_pacientes", "");
...
function reporteEstadisticopaciente2(idPaciente) {
    ...
    llamarAjax("reporte_despacho_medicamentos_ajax.php", params, "reporteEstadistico", "descargar_pdf2();");
}
...
function reporteEstadisticopaciente() {
	if (validarReporteEstadisticoPaciente()) {
		...
		llamarAjax("reporte_despacho_medicamentos_ajax.php", params, "reporteEstadistico", "descargar_pdf2();"); //descargar_pdf();
	}
}
...
function abrir_buscar_concepto() {
    ...
    llamarAjax("reporte_despacho_medicamentos_ajax.php", params, "d_interno_conceptos", "");
...
function buscar_procedimientos() {
    ...
    llamarAjax("reporte_despacho_medicamentos_ajax.php", params, "d_buscar_procedimientos", "");
}
...
function buscar_paciente() {
    ...
    llamarAjax("reporte_despacho_medicamentos_ajax.php", params, "d_buscar_pacientes", "");
}
...
function seleccionar_convenio(id_convenio) {
    ...
    llamarAjax("reporte_despacho_medicamentos_ajax.php", params, "d_plan", "");
}
