<?php
	session_start();
	/*
	  Reporte general de Tiempos de atención
	  Autor: ZJJC - 12/04/2017
	 */
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type='text/javascript' src='reporte_tiempos_atencion.js'></script>
        ...
        <div class="title-bar">
            <div class="wrapper">
                <div class="breadcrumb">
                    <ul>
                        <li class="breadcrumb_on">Reporte Tiempos de Atención</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="contenedor_principal">
            <div class="padding">     
                <fieldset style="text-align: left;">
                    <legend>Reporte Tiempos de Atención</legend>
                    <div>
                        <table border="0" cellpadding="5" cellspacing="0" style="width:100%;">
                            <tr>
                                ...
                                <td align="center" rowspan="3" style="width:20%;">
                                    ...
                                    <form name="frm_excel_general" id="frm_excel_general" action="reporte_tiempos_atencion_excel2.php" method="post" style="display:none;" target="_blank">
                            ...
                            <tr>
                                <td align="right">
                                	<label class="inline">M&eacute;dico</label>
                                </td>
                                <td>
                                    <?php $combo->getComboDb("cmbConvenio", '', $lista_convenios, "id_convenio, nombre_convenio", "Seleccione el convenio o entidad", "seleccionar_convenio(this.value);", "", "width:250px;"); ?>
                                </td>
                                ...
                                <td>
                                	<div id="d_plan">
                                    <?php $combo->getComboDb("cmbPlan", '', $lista_convenios, "id_plan, nombre_plan", "Todos los planes", "", "", "width:250px;"); ?>
                                    </div>
                                </td>
                            </tr>							
                        </table>
