<?php
	session_start();
	/*
	  Reporte de tipos de mercadeo
	  Autor: Jhonatan Mantilla  - 02/04/2020
	 */
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type='text/javascript' src='reporte_mercadeo.js'></script>
        ...
        <div class="title-bar">
            <div class="wrapper">
                <div class="breadcrumb">
                    <ul>
                        <li class="breadcrumb_on">Reporte de mercadeo</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="contenedor_principal volumen">
            <div class="padding">     
                <fieldset style="text-align: left;">
                    <legend>Reporte general de mercadeo</legend>
                    <div>
                        <table border="0" cellpadding="5" cellspacing="0" style="width:100%;">
                            <tr>
                                ...
                                <td align="center" rowspan="3" style="width:20%;">
                                    ...
                                    <form name="frm_excel_general" id="frm_excel_general" action="reporte_mercadeo.excel.php" method="post" style="display:none;" target="_blank">
                                        ...
                                        <input type="hidden" id="hddmercadeo" name="hddmercadeo" />
                            ...
                            <tr>
                                <td align="right">
                                	<label class="inline">Tipo de Mercadeo</label>
                                </td>
                                <td>
                                	<?php //$combo->getComboDb("cmbUsuarioAdm", '', $usuarios->getListaUsuariosAcceso(array(14), 2), "id_usuario, nombre_completo", "Seleccione el usuario", "", "", "width:250px;"); ?>
                                    <?php
									
									   $lista_mercadeo = $dbListas->getListasMercadeoAdmision();
									   //var_dump($lista_mercadeo);
									   
	                                    $combo->getComboDb('cmb_lista_mercadeo', '',  $lista_mercadeo,  'id_lista, nombre_lista',  'Seleccione tipo de mercadeo', 'width:250px;');
										?>
                                </td>
                                <td align="right">
                                ...
                                <td>
                                    <?php //$combo->getComboDb("cmbUsuario", '', $usuarios->getListaUsuariosAcceso(array(18), 2), "id_usuario, nombre_completo", "Seleccione el usuario", "", "", "width:250px;"); ?>
                                    <?php
	                                	$lista_lugares = $dbListas->getListaLugaresMercadeo();
	                                	$combo->getComboDb("cmb_lugar_cita", '', $lista_lugares, "id_detalle, nombre_detalle", "Seleccionar Lugar", "", true, "width: 210px;");
	                                ?>
                                </td>
                            </tr>
                        </table>
