<?php
	...
	/*
	  ...
	  Autor: Jhonatan Mantilla Arenas- 18/10/2019
	 */
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type='text/javascript' src='reporte_oportunidad_atencion.js'></script>
        ...
        <div class="title-bar">
            <div class="wrapper">
                <div class="breadcrumb">
                    <ul>
                        <li class="breadcrumb_on">Reporte de oportunidad de atención</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="contenedor_principal volumen">
            <div class="padding">     
                <fieldset style="text-align: left;">
                    <legend>Reporte General Oportunidad de Atención</legend>
                    <div>
                        <table border="0" cellpadding="5" cellspacing="0" style="width:100%;">
                            <tr>
                                ...
                                <td align="center" rowspan="3" style="width:20%;">
                                    ...
                                    <form name="frm_excel_general" id="frm_excel_general" action="reporte_oportunidad_atencion_excel.php" method="post" style="display:none;" target="_blank">
                                        ...
                                        <input type="hidden" id="hddsede" name="hddsede" />
                             ...
                             <td align="right">
                                ...
                                <td>
                                    ...
                                    <?php
	                                	...
	                                	$combo->getComboDb("cmbSede", '', $lista_lugares, "id_detalle, nombre_detalle", "--Todos los lugares--", "", true, "width: 210px;");
	                                ?>
                                </td>
                        </table>
                    </div>
