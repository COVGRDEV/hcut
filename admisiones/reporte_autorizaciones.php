...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type='text/javascript' src='reporte_autorizaciones.js'></script>
        ...
        <div class="title-bar">
            <div class="wrapper">
                <div class="breadcrumb">
                    <ul>
                        <li class="breadcrumb_on">Reporte de Autorizaciones</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="contenedor_principal">
            <div class="padding">     
                <fieldset style="text-align: left;">
                    <legend>Reporte de Autorizaciones</legend>
                    <div>
                        <table border="0" cellpadding="5" cellspacing="0" style="width:100%;">
                            <tr>
                                ...
                                <td align="center" rowspan="3" style="width:20%;">
                                    ...
                                    <form name="frm_excel_general" id="frm_excel_general" action="reporte_autorizaciones_excel.php" method="post" style="display:none;" target="_blank">
