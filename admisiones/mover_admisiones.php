...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type='text/javascript' src='mover_admisiones_v1.4.js'></script>      
    </head>
    <body>
        <?php
        ...
        <div class="title-bar">
            <div class="wrapper">
                <div class="breadcrumb">
                    <ul>
                        <li class="breadcrumb_on">Cambios en admisiones</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="contenedor_principal">
            ...
            <div class="formulario" id="principal_frm_formulas" style="width: 100%; display: block; ">
                    ...
                    <table id="buscar" border="0" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="width: 40%;text-align: left;">
                                <input class="btnPrincipal peq" type="submit" value="Consultar" id="btn_consultar" name="btn_consultar" onclick="validar_buscar_paciente();" />
                            </td>
                        </tr>
                    </table>
                </form>
                <div id="d_contenedor_admision" style="min-height: 30px;"></div>
            </div>
        </div>
