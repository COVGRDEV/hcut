...
switch ($opcion) {
        ...
        <div style="width: 90%; margin: 0 auto;padding: 5px 0px">
            ...
            if ($cantidadAutorizaciones >= 1) {
                ...
                <div>
                    ...
                    <table style="width:100%;" id="tablaAutorizaciones" class="modal_table">
                        <tbody><tr id="tabla_encabezado">
                            ...
                            foreach ($lista_autorizaciones as $autorizacion) {
								...
								$id_pago = $autorizacion["id_pago"];
								
								$fechaNuevaVencimientoAuto =  new DateTime($autorizacion["fecha_nueva_vence_auto"]);
								$fechaRenovacionAuto =  new DateTime($autorizacion["fecha_renovacion_auto"]);
								$fechaActual=new DateTime(date("Y-m-d"));
								$fechaCreaAuto = new DateTime($autorizacion["fecha_crea_auto"]);
								$fechaVencimientoAuto = new DateTime($autorizacion["fecha_venc_auto"]);
								
								if($autorizacion["fecha_nueva_vence_auto"]=="" && $autorizacion["fecha_renovacion_auto"]==""){
									$dif_crea_vence=$fechaCreaAuto->diff($fechaVencimientoAuto);
									$dif_actual_crea=$fechaCreaAuto->diff($fechaActual); 
									($dif_crea_vence->days)>($dif_actual_crea->days) ? $banderaBtnRenovar : $banderaBtnRenovar=true;							
								}else{
									$dif_crea_vence=$fechaRenovacionAuto->diff($fechaNuevaVencimientoAuto);
									$dif_actual_crea=$fechaRenovacionAuto->diff($fechaActual); 
									($dif_crea_vence->days)>($dif_actual_crea->days) ? $banderaBtnRenovar : $banderaBtnRenovar=true;									
								}
                                ...
                                switch ($autorizacion["ind_estado_auto"]) {
                                    ...
                                    case 1://Autorizado
										...
										$banderaBtnRenovar ? $banderaBtnLiquidar : $banderaBtnLiquidar=true;
                                        break;
                                ...
                                <tr style="<?= $backgroundAux ?>">
                                   ...
                                   <!-- <td style="" class="td_reducido">
                                    ...
                                    <td class="td_reducido">
                                        ...
                                        <?= $combo->getComboDb("cmb_convenio_" . $contador, $autorizacion["id_convenio"], $dbConvenios->getListaConveniosActivosAutorizaciones(), "id_convenio, nombre_convenio", "--Seleccione--", "seleccionar_convenio('cmb_conveniocmb_convenio_" . $contador . "', " . $contador . ");", 0, $displaySeleccionar, "") ?>
                                    </td>
                                    <td class="td_reducido">
                                        <div id="d_cmb_plan">
                                            <?= $combo->getComboDb("cmb_plan_" . $contador, $autorizacion["id_plan"], $dbPlanes->getListaPlanesActivosAutorizaciones($autorizacion["id_convenio"]), "id_plan, nombre_plan", "--Seleccione--", "", 0, $displaySeleccionar, "") ?>
                                        </div>                                        
                                    </td>
                                    <td class="td_reducido">
                    ...
                    }else if($banderaBtnRenovar){
						 ?>
                            <div>
                                <div style="text-align:center;">
                                    <br>
									<select id="select_renovar_auto" style="width:300px;">
										<option value="">Renovar por...</option>
										<option value="1">1 mes</option>
										<option value="2">2 meses</option>
										<option value="3">3 meses</option>
									</select>
									<input type="button" id="btn_renovar_autorizacion" name="btn_renovar_autorizacion" value="Renovar autorizaci&oacute;n" class="btnPrincipal peq" onclick="renovar_autorizacion();" />
                                    <div id="d_renovar" style="display:none"></div>
                                </div>
                            </div>
						<?php
					}
    ...
    case "6"://Autorización con base en orde medica detalle
    ...
    case "7"://Orden procedimiento Detalle
        ...
        //Verifica si la autorización fue realizada con base en un detalle de la orden médica
        if (strlen($autorizacion["id_orden_m_det"]) >= 1) {
            //Verifica el tipo de orden médica
            ...
            <table style="width: 85%;margin: 0 auto;">
                ...
                <tr>
                    ...
                    <td align="left" class="verde">
					 ...
					 if($lista_perfiles_usuario[0]["ind_modificar_autorizaciones"] == "1"){
                                    ...
                                    $combo->get("cmb_ojo", $ojo, $array_statusAseguradora, "-- Seleccione --", "", "", "", "", "no-margin");
					 }else{
						  echo($textoOjo);
					 }
                     ?> 
				...
				<tr>
					...
					<br><b>Proveedores</b>
                        <table style="width:75%; margin:auto;">
							...
							if(!is_null($autorizacion["proveedor_sala"])){ ?>
									<tr id="tr_codProvModal_sala">
										<td align="right" style="width:100px;"><b>Sala:</b></td>
										<td align="left" style="width:600px;">
											<input type="hidden" id="codProvModalSala" value="<?=$autorizacion["id_proveedor_sala"] ?>" />
											<span id="nomProvModalSala" ><?= $autorizacion["proveedor_sala"] ?></span>
										</td>
										<td align="center" style="width:5%;">
											<div class="d_buscar" onclick="btnVentanaBuscarProveedor(1);"></div>
										</td>
									</tr>
							<?php } if(!is_null($autorizacion["proveedor_anestesia"])==true){ ?>
									<tr id="tr_codProvModal_anestesia">
										<td align="right" style="width:100px;"><b>Anestesia:</b></td>
										<td align="left" style="width:600px;">
											<input type="hidden" id="codProvModalAnestesia" value="<?=$autorizacion["id_proveedor_anestesiologo"] ?>" />
											<span id="nomProvModalAnestesia"><?= $autorizacion["proveedor_anestesia"] ?></span>
										</td>
										<td align="center" style="width:5%;">
											<div class="d_buscar" onclick="btnVentanaBuscarProveedor(2);"></div>
										</td>
									</tr>
							<?php } if(!is_null($autorizacion["proveedor_especialista"])){ ?>
									<tr id="tr_codProvModal_especialista">
										<td align="right" style="width:100px;"><b>Especialista:</b></td>
										<td align="left" style="width:600px;">
											<input type="hidden" id="codProvModalEspecialista" value="<?= $autorizacion["id_proveedor_especialista"] ?>" />
											<span id="nomProvModalEspecialista"><?= $autorizacion["proveedor_especialista"] ?></span>
										</td>
										<td align="center" style="width:5%;">
											<div class="d_buscar" onclick="btnVentanaBuscarProveedor(3);"></div>
										</td>
									</tr>
							<?php } if(!is_null($autorizacion["proveedor_materiales"])){ ?>
									<tr id="tr_codProvModal_materiales">
										<td align="right" style="width:100px;"><b>Materiales:</b></td>
										<td align="left" style="width:600px;">
											<input type="hidden" id="codProvModalMateriales" value="<?= $autorizacion["id_proveedor_materiales"]?>" />
											<span id="nomProvModalMateriales"><?= $autorizacion["proveedor_materiales"] ?></span>
										</td>
										<td align="center" style="width:5%;">
                ...
                <tr>
                    <td align="center" colspan="3">
						...
						<?php
						if ($autorizacion["ind_estado_auto"]==2 || $autorizacion["ind_estado_auto"] != 0){

							if ($autorizacion["ind_estado_auto"] == 2 && $autorizacion["estado_pago"]==2) { //Sí se encuentra con registrados siesa?>
						   ...
						   <?php
							...
							}if($lista_perfiles_usuario[0]["ind_modificar_autorizaciones"] == "1"){//Solo se muestra el botón a los que tengan los permisos de modificar autorizaciones.
							?>
								<input class="btnPrincipal" type="button" value="Actualizar autorización" id="btn_actualizar_auto" name="btn_actualizar_auto" onclick="actualizar_autorizacion();" />
							<?php
							}
						}
							?>
    ...
    case "8":
		...
		if(!is_null($autorizacion["id_proveedor_sala"])){
			...
			if($autorizacion["fecha_nueva_vence_auto"] != NULL){
				$fecha_autorizacion_venc = $autorizacion["fecha_nueva_vence_auto"];
			}else{
				$fecha_autorizacion_venc = $autorizacion["fechaVencimiento"];
			}	
				...
				$pdf->SetFont("Arial", "", $fontSize);
				$pdf->Cell(30, 4, ajustarCaracteres($fecha_autorizacion_venc), 0, 0, "L");
				$y_aux += 4;
				$pdf->SetY($y_aux);
				$pdf->SetX(50);
				$pdf->SetFont("Arial", "B", $fontSize);
				...
				$pdf->SetFont("Arial", "B", $fontSize);
				$pdf->SetFont("Arial", "B", $fontSize);
				$pdf->Cell(27, 4, ajustarCaracteres("NÚMERO FACTURA:"), 1, 0, "L");
				$pdf->SetFont("Arial", "", $fontSize);
				$pdf->Cell(69, 4, ajustarCaracteres($datos_autorizacion["num_factura"]), 1, 0, "L");
				$pdf->SetFont("Arial", "B", $fontSize);
				$pdf->Cell(27, 4, ajustarCaracteres("VALOR CUOTA:"), 1, 0, "L");
				$pdf->SetFont("Arial", "", $fontSize);
				$pdf->Cell(69, 4, ajustarCaracteres($datos_autorizacion["valor_cuota_liq"]), 1, 1, "L");
				$pdf->SetFont("Arial", "B", $fontSize);
				$pdf->Cell(27, 4, ajustarCaracteres("VALOR TOTAL:"), 1, 0, "R");
				$pdf->SetFont("Arial", "", $fontSize);
				$pdf->Cell(165, 4, ajustarCaracteres($datos_autorizacion["valor_liq"]), 1, 1, "L");
				$pdf->SetX(10);
		...
		//PDF para derechos de especialista
    ...
    case "17"://Cancelar autorización
		...
		$idOrdenMedica = $utilidades->str_decode($_POST["idOrdenMedica"]);
        $rta = $dbAutorizaciones->desautorizarProcedimiento($idAutorizacion, $observacion, $usuario, $lugar, $idOrdenMedica);
    ...
    case "18": //Registrar pago de la autorización
		...
		for ($i = 0; $i < $cant_autorizaciones; $i++) {
			...
			//Se busca si el procedimiento tiene indicador examen
            ...
            foreach ($lista_autorizaciones_det as $aut_det_aux) {
				...
				/*if (isset($precio_obj["id_proc_examen"])) {
                    
					$id_proc_exam_aux = $precio_obj["id_proc_examen"];
                ...
                if (!$ind_hallado_busq_aux) {
					...
					//$arr_aut_aux["id_proc_examen"] = $id_proc_exam_aux; 
    ...
    case "22": //Búsqueda de diagnósticos por código
		...
		case "23": // Renovación de la autorizaciòn
			@$cantidad_meses = $utilidades->str_decode($_POST["cantidad_meses"]);
			@$id_ordern_medica = $utilidades->str_decode($_POST["id_ordern_medica"]);
			$rta = $dbAutorizaciones->renovarAutorizacion($cantidad_meses, $id_ordern_medica);
			
        ?>
      
			<input type="hidden" id="hdd_result_renovacion" name="hdd_result_renovacion" value="<?=$rta?>" />
        <?php
        break;
	
		case "24": //Actualización de proveedores en la autorización
		
		@$id_auto = $utilidades->str_decode($_POST["id_auto"]);
		@$id_prov_sala = $utilidades->str_decode($_POST["id_prov_sala"]);
		@$id_prov_anes = $utilidades->str_decode($_POST["id_prov_anes"]);
		@$id_prov_esp = $utilidades->str_decode($_POST["id_prov_esp"]);
		@$id_prov_mat = $utilidades->str_decode($_POST["id_prov_mat"]);
		@$idOjo = $utilidades->str_decode($_POST["idOjo"]);
		
		$rta = $dbAutorizaciones->actualizarAutorizacion($id_auto,$id_prov_sala, $id_prov_anes, $id_prov_esp, $id_prov_mat, $idOjo);
		
        ?>
			<input type="hidden" id="hdd_result_actualizacion" name="hdd_result_actualizacion" value="<?=$rta?>" />
		<?php
        break;
