...
function reporteGeneral() {
	...
	var id_mercadeo = $('#cmb_lista_mercadeo').val();
    ...
    if (fechaInicial == '' || fechaFinal == '') {
        ...
        var params = 'opcion=1&fecha_inicial=' + str_encode(fechaInicial) +
					 '&fecha_final=' + str_encode(fechaFinal) +
					 '&id_convenio=' + id_convenio +
					 '&id_plan=' + id_plan +
					 'id_mercadeo=' + id_mercadeo+
					 '&id_usuario_adm=' + usuario_adm +
					 '&id_usuario=' + usuario;
		
        llamarAjax("reporte_mercadeo_ajax.php", params, "reporte", "descargar_pdf();");
    }
}
...
function ventanaPacientes(tipo) {
    if (tipo == 1) {//mostrar
        ...
        llamarAjax("reporte_mercadeo_ajax.php", params, "d_interno_pacientes", "");
...
function reporteEstadisticopaciente2(idPaciente) {
    ...
    llamarAjax("reporte_mercadeo_ajax.php", params, "reporteEstadistico", "descargar_pdf2();");
}
...
function reporteEstadisticopaciente() {
	if (validarReporteEstadisticoPaciente()) {
		...
		llamarAjax("reporte_mercadeo_ajax.php", params, "reporteEstadistico", "descargar_pdf2();"); //descargar_pdf();
	}
}
...
function abrir_buscar_concepto() {
    ...
    llamarAjax("reporte_mercadeo_ajax.php", params, "d_interno_conceptos", "");
...
function buscar_procedimientos() {
    ...
    llamarAjax("reporte_mercadeo_ajax.php", params, "d_buscar_procedimientos", "");
}
...
function seleccionar_convenio(id_convenio) {
    ...
    llamarAjax("reporte_mercadeo_ajax.php", params, "id_plan", "");
}
