...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function call($operation,$params=array(),$namespace='http://generictransfer.com/',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
